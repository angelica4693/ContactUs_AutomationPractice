...
public class No_Subject_Heading {
	WebDriver driver;
	String browser;
	public No_Subject_Heading(WebDriver driver)
	{
		this.driver = driver;
	}
	...
	public void Entering_Email()                              //Entering Email
	{
	...
	public void Screenshot() throws IOException            //Taking the Screenshot
	{
		...
		Files.copy(f, new File("D:\\LOGA\\ContactUS_AutomationPractice\\Screenshots\\No_Subject.PNG"));
	}
